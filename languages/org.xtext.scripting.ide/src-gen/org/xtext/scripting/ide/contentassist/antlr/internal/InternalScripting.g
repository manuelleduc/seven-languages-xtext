...
:
(
	{ before(grammarAccess.getScriptAccess().getExpressionsAssignment_1_0()); }
	(rule__Script__ExpressionsAssignment_1_0)
	{ after(grammarAccess.getScriptAccess().getExpressionsAssignment_1_0()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getScriptAccess().getExpressionsXExpressionOrVarDeclarationParserRuleCall_1_0_0()); }
		ruleXExpressionOrVarDeclaration
		{ after(grammarAccess.getScriptAccess().getExpressionsXExpressionOrVarDeclarationParserRuleCall_1_0_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
