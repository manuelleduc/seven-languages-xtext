 ...
 */
package org.xtext.scripting.ide.contentassist.antlr;
...
import org.xtext.scripting.ide.contentassist.antlr.internal.InternalScriptingParser;
...
public class ScriptingParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalScriptingParser createParser() {
		InternalScriptingParser result = new InternalScriptingParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getScriptAccess().getExpressionsAssignment_1_0(), "rule__Script__ExpressionsAssignment_1_0");
